...
{
    public static class DataExportTest
    {
        private static double maxWaitSeconds;
        private static object byLocatorType;
        private static IWebElement element;

        public static void DataExport(IWebDriver driver, ExtentReports extent)
        {
            var test = extent.CreateTest("Royal Navy - Data Export Test").Info("Test Started");
            ...
            selectElement.SelectByText("Daily");
