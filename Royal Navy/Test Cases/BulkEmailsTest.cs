...
{
    public static class BulkEmailsTest
    {
        private static double maxWaitSeconds;
        private static object byLocatorType;
        private static IWebElement element;

        public static void BulkEmails(IWebDriver driver, ExtentReports extent)
        {
            var test = extent.CreateTest("Royal Navy - Bulk Emails Test").Info("Test Started");
            ...
            driver.FindElement(By.CssSelector("li:nth-child(14) img")).Click();
