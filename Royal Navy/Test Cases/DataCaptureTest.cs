...
{
    public static class DataCaptureTest
    {
        private static double maxWaitSeconds;
        private static object byLocatorType;
        private static IWebElement element;

        public static void DataCapture(IWebDriver driver, ExtentReports extent)
        {
            var test = extent.CreateTest("Royal Navy - Data Capture Test").Info("Test Started");
            ...
            driver.FindElement(By.CssSelector("li:nth-child(10) img")).Click();
